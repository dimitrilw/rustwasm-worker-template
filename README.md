...
Before compiling or deploying, you must confirm that both Cargo.toml and wrangler.toml have had the
"name" variable replaced with your project's name, and also add any other configuration you need.
